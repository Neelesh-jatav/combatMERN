...
import { register, resetAuthSlice } from "../store/slices/authSlice"; // Ensure this import is correct
...
const Register = () => {
  ...
  md:flex-row h-screen">
    ...
    >
      <div className="text-center h-[376px]">
        ...
        <p className="text-gray-300 mb-12">
          Already have account? Sign in now.</p>
        <Link to = {"/login"} className="border-2 
        rounded-lg font-semibold border-white py-2 px-8
    ...
    {/* {RIGHT SIDE} */}
    <div className="w-full md:w1/2 flex items-center
    justify-center bg-white p-8">
      <div className="w-full max-w-sm">
        ...
        mb-12">Please provide your information to sign up.
        </p>
        <form onSubmit={handleRegister}>
          <div className="mb-2">
            ...
            border-black rounded-md focous:outline-none"
            />
          </div>
          <div className="mb-2">
            <input 
